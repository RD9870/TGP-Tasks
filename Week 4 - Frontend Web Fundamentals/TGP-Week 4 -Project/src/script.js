...
function fillDropDown(items, container) {
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    //if it's the all option add a hidden class
...
function fetchThisCat(cat) {
  const allListItem = document.getElementById("all-option");
  if (cat == "All categories") {
    fillProdCards(products);
    // categories.remove("All Categories");
    allListItem.classList.add("hidden");
  } else {
    ...
    console.log(`all items list ${allListItem.textContent}`);
    allListItem.classList.remove("hidden");
...
// container <li><a href="#" class="drop-down-item">electronics</a></li>

// <li><a href="#" class="drop-down-item">jewelery</a></li>

// <li><a href="#" class="drop-down-item">men's clothing</a></li>

// <li><a href="#" class="drop-down-item">women's clothing</a></li>

// <li><a href="#" class="drop-down-item hidden all-option">All categories</a></li>
